...
# Dari A ke D
# city_map = Graph(dict(
# 	A=dict(A=0, B=12, C=17, D=22, E=12),
# 	B=dict(A=12, B=0, C=8, D=23, E=24),
# 	C=dict(A=17, B=8, C=0, D=15, E=25),
# 	D=dict(A=22, B=23, C=15, D=0, E=10),
# 	E=dict(A=12, B=24, C=25, D=10, E=0)),
# 	directed=False)

# city_map = Graph(dict(
# 	A=dict(A=0, B=15, C=18, D=10, E=30),
# 	B=dict(A=15, B=0, C=9, D=25, E=15),
# 	D=dict(A=10, B=25, C=8, D=0, E=20),
# 	C=dict(A=18, B=9, C=0, D=8, E=24),
# 	E=dict(A=20, B=15, C=24, D=20, E=0)),
# 	directed=False)

# a ke c
# city_map = Graph(dict(
# 	A=dict(A=0, D=10, C=18),
# 	D=dict(A=10,C=8, D=0),
# 	C=dict(A=18, C=0, D=8)),
# 	directed=False)